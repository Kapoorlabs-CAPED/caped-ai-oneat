...
split_image_dir = '/gpfsstore/rech/jsy/uzj81mi/Mari_Data_Oneat/raw/gt_split/'
split_save_dir = '/gpfsstore/rech/jsy/uzj81mi/Mari_Data_Oneat/raw/gt_split/seg/'
...
roi_model = None #MASKUNET(config = None, name = roi_model_name, basedir = model_dir)
