...
npz_directory = '/gpfsstore/rech/jsy/uzj81mi/Mari_Data_Training/oneat_training/oneat_train_patches_m2p2/'
npz_name = 'Xenopus_oneat_training_m2p2.npz'
npz_val_name = 'Xenopus_oneat_training_m2p2val.npz'

#Read and Write the h5 file, directory location and name
model_dir =  '/gpfsstore/rech/jsy/uzj81mi/Mari_Models/Oneat/'
model_name = 'Cellsplitdetectortmtp22d29f32l16.h5'
