...
class NEATLRNet:
    ...
    def __init__(
        self, config: dict, model_dir: str, catconfig: dict, cordconfig
    ):
                ...
                if str(int(inputtime)) in self.marker_tree:
                    ...
                    for i in range(len(location)):
                        ...
                        if (
                            ...
                            and crop_image.shape[1] >= self.imagey
                            and crop_image.shape[2] >= self.imagex
                        ):
                            ...
                            if sum_time_prediction is not None:
                                ...
                                if (
                                    ...
                                    boxprediction[0]["xstart"] = boxprediction[
                                        0
                                    ]["xcenter"] - int(self.imagex / 2)
                                    boxprediction[0]["ystart"] = boxprediction[
                                        0
                                    ]["ycenter"] - int(self.imagey / 2)
                                    eventboxes = eventboxes + boxprediction
