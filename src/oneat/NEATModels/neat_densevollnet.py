...
class NEATDenseVollNet(object):
    ...
    def predict(self, 
        ...
        #Normalize in volume
        for inputtime in tqdm(range(0, self.originalimage.shape[0]- self.imaget, self.imaget)):
            self.originalimage[inputtime:inputtime+self.imaget] = normalizeFloatZeroOne(self.originalimage[inputtime:inputtime+self.imaget], 1, 99.8, dtype = self.dtype)
