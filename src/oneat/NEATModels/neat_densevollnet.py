...
class NEATDenseVollNet:
    ...
    def get_markers(self, segimage: np.ndarray):
        ...
        self.markers = GenerateVolumeMarkers(
            self.segimage, pad_width=self.pad_width
        )
    ...
    def overlaptiles(self, sliceregion: np.ndarray):
        ...
        if self.n_tiles == (1, 1, 1):
            ...
            if (
                patchx > self.imagex
                and patchy > self.imagey
                and patchz > self.imagez
            ):
                ...
                if (
                    ...
                    for pair in pairs:
                        (
                            ...
                            smallrowout,
                            smallcolumn,
                        ) = chunk_list(sliceregion, patchshape, pair)
                        if (
