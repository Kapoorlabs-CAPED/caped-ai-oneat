...
class OneatWidget(QWidget):
    ...
    def __init__(
        ...
        self._capture_image_callback(segimagedir, heatimagedir, heatname, start_project_mid, end_project_mid ))
    ...
    def _capture_image_callback(self, segimagedir, heatmapimagedir, heatname, start_project_mid, end_project_mid):

         get_image_text = self.frameWidget.imageidbox.currentText()
         imagename = os.path.basename(os.path.splitext(get_image_text)[0])
         self.oneatvisualization.show_image(get_image_text, imagename, segimagedir, heatmapimagedir, heatname,
         start_project_mid, end_project_mid)
