...
class NEATSynamic(NEATDynamic):
    ...
    def predict_synamic(self,imagename, savedir, n_tiles = (1,1), overlap_percent = 0.8, event_threshold = 0.5, event_confidence = 0.5, iou_threshold = 0.1, fidelity = 5,
     downsamplefactor = 1, maskimage = None, maskfilter = 10,start_project_mid = 4, end_project_mid = 4, maskmodel = None):
        ...
        fidelity = fidelity, start_project_mid = start_project_mid, end_project_mid = end_project_mid, downsamplefactor = downsamplefactor, maskimage = maskimage, maskfilter = maskfilter,  markers = None, marker_tree = None,
         remove_markers = None, maskmodel = maskmodel )